---
title: "Significance Analysis of Microarrays (SAM) applied to Proteomics"
...
Follow the instructions to install the package [samr](https://github.com/MikeJSeo/SAM) and its dependencies. You can use the shiny app that work well.
...
sam_result <- samr::SAM(x = imputation_list, 
                y = condition_for_design,
                resp.type = "Two class unpaired",
                geneid = rownames(imputation_list),
                genenames = rownames(imputation_list),
                s0 = 0.1, 
                s0.perc = NULL, 
                nperms = 1000,
                center.arrays=FALSE,
